...
private:
    ...
    void start_audio_capture(size_t index, bool reconnecting = false);
    void rebuild_audio_menu();
    void ensure_audio_health();
    ...
    bool worker_expected_{};
    bool suppress_test_frames_{};
    uint64_t worker_recovery_attempts_{};
    std::wstring worker_restart_error_;
    bool capture_expected_{};
    bool capture_failed_{};
    bool capture_interrupted_{};
    bool reconnecting_capture_{};
    bool isolated_test_settings_{};
    std::optional<CaptureMode> reconnect_mode_;
    std::wstring reconnect_device_link_;
    std::wstring capture_recovery_error_;
    uint64_t capture_started_ms_{};
    uint64_t last_capture_retry_ms_{};
    uint64_t capture_recovery_attempts_{};
    std::atomic_uint64_t last_capture_frame_ms_{};
    ...
    uint64_t last_audio_retry_ms_{};
    uint64_t audio_recovery_attempts_{};
    std::atomic_uint64_t audio_generation_{};
};
